  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-white dark:bg-black overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none -z-10">
        <div className="nova-glow top-[-20%] left-[-10%] w-[60%] h-[60%] bg-indigo-300 dark:bg-indigo-700" />
        <div className="nova-glow bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-violet-200 dark:bg-violet-800" />
      </div>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <FiUser className="absolute left-5 top-1/2 transform -translate-y-1/2 text-slate-300 group-focus-within:text-indigo-500 transition-colors" size={18} />
                  <input
                    type="text"
                    name="name"
                    value={formData.name}
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <FiDollarSign className="absolute left-5 top-1/2 transform -translate-y-1/2 text-slate-300 group-focus-within:text-indigo-500 transition-colors" size={18} />
                <select
                  name="currency"
          ...
          <div className="mt-8 pt-6 border-t border-slate-50 dark:border-slate-800 text-center">
            <p className="text-xs font-bold text-slate-400 uppercase tracking-widest leading-loose">
              ...
              <Link to="/login" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 transition-colors inline-flex items-center gap-2">
